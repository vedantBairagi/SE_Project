...
cas = ('Bookman Old Style', 10)
cas_big = ('Bookman Old Style', 20)
...
def text_steno():
    ...
    win_label = Label(win, text='Text-Steganography', font=cas_big, bg='#c0ed98', fg='#1046b3', justify='center')
